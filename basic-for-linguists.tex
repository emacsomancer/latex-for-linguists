...
% use Latin Modern rather than Computer Modern
\usepackage{fontspec}
...
\usepackage[pdfusetitle,pdfcreator={GNU Emacs 30.2 (build 2, Lucid/Athena-toolkit (X toolkit), no scroll bars, cairo version 1.18.4) with AUCTeX 14.1.0 on Guix System (Linux 6.17.10 [\#1 SMP PREEMPT＿DYNAMIC 1])},colorlinks   = true, %Colours links instead of ugly boxes
