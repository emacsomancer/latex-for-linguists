...
\usepackage[margin=1.55in]{geometry}  % set margins
...
\title{\sffamily Basic \LaTeX\ for Linguists} % title
\author{\sffamily\bfseries\href{https://slade.jnanam.net}{Benjamin Slade}} % author
\date{v0.1}
...
The following sections include actual \LaTeX\ code in {\color{ForestGreen}\fbox{boxed in green}} with the corresponding output shown in \fbox{black box}. You can copy and paste the green code into your editor, and/or inspect \href{./basic-for-linguists.tex}{the \texttt{.tex} file} from which this \texttt{.pdf} was generated.
...
\begin{wrapfigure}{R}{0.3\textwidth}
  \centering
\href{https://xkcd.com/2109/}{\includegraphics[width=2in]{invisible_formatting.png}}
\end{wrapfigure}
...
\includegraphics[width=5in]{geneve_1564.png}\\
\url{https://github.com/raphink/geneve_1564}

\subsection{Aphra Behn: A Pindarick on Charles II}
\includegraphics[width=5.25in]{behn-pindarick-charles-ii-first-page.pdf}\\
...
\subsection{Ramāya\textipa{\d{n}}a excerpt}
